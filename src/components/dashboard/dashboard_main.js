                ...
                <div className="flex overflow-hidden bg-white pt-16">
                                        ...
                                        <div className="mx-auto">
                                            <div className='mt-4 mb-8'>
                                                <div className='w-full flex justify-center'>
                                                    ...
                                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Nike_SB_logo.jpg/640px-Nike_SB_logo.jpg" className="shadow-xl h-40 w-40 rounded-full border-none" />
                                                </div>
                                            ...
                                            <div className="text-center mt-2">
                                                ...
                                                <div className="mb-2 text-blueGray-600 mt-10">
                                                    ...
                                                    Nike Store, Shop no 11, Ostwal Empire, Boisar - 401504
                                                </div>
                                            </div>
                    ...
                    <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                                    ...
                                    <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                                        ...
                                        <div className="p-3">
                                            <div className="overflow-x-auto">
                                                <h3 className="text-xl leading-none font-bold text-gray-900 mb-10">Products</h3>
                                                    ...
                                                    <tbody className="text-sm divide-y divide-gray-100">
                                                        <tr>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="flex items-center">
                                                                    <div className="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img className="rounded-full" src="https://n4.sdlcdn.com/imgs/i/a/l/Nike-Air-Max-270-White-SDL805065450-1-6ec80.jpeg" width={40} height={40} alt="Alex Shatov" /></div>
                                                                    <div className="font-medium text-gray-800">Air Max</div>
                                                                </div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-left">256</div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-left font-medium text-green-500">₹2,590</div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-center font-medium">The first Air...</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="flex items-center">
                                                                    <div className="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img className="rounded-full" src="https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/585e2cd2-4f2a-408c-a8ba-f89952cdf332/revolution-6-next-nature-road-running-shoes-NC0P7k.png" width={40} height={40} alt="Alex Shatov" /></div>
                                                                    <div className="font-medium text-gray-800">Air Revolution</div>
                                                                </div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-left">896</div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-left font-medium text-green-500">₹5,900</div>
                                                            </td>
                                                            <td className="p-2 whitespace-nowrap">
                                                                <div className="text-center font-medium">6 Nature Men...</div>
                                                            </td>
                                                        </tr>
                        ...
                        <p className="text-center text-sm text-gray-500 my-10">
                            © 2023-2024 <a href="#" className="hover:underline" target="_blank">V-Track</a>. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
