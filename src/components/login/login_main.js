...
const Login_Main = (props) => {
  ...
  function login_() {
      ...
      const response = axios.post('https://b134-2401-4900-57f5-a248-3868-2307-22c9-d91e.in.ngrok.io/api/signin', {},params)
          // .then(res => {
          //     document.getElementById('direct_to_dashboard').click();
          // })
  ...
  return (
    <>
      <Link to='/dashboard' id='direct_to_dashboard' className="absolute bottom-0 left-0 invisible ...">dashboard</Link>
    ...
    >
      ...
      <div className="w-full  max-w-md z-10">
        ...
        <div className="sm:text-sm xl:text-md text-gray-200 font-normal">
          {" "}
          Are you aware who wants your product? <br></br>
Do you know who is your best trading partner?<br></br>
Want to focus on the market where its easy to sell?<br></br>
if yes then this is what we do at Vtrack!!!<br></br>
Helping you with data that can boost your sales and market share<br></br>
        </div>
      </div>
      {/*-remove custom style*/}
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="email"
              placeholder="mail@gmail.com" value={email} onChange={evt => inputEmail(evt.target.value)} required
            />
          </div>
          <div className="mt-8 content-center">
            ...
            <input
              ...
              type="password"
              placeholder="Enter your password" value={password} onChange={evt => inputPassword(evt.target.value)} required
            />
          </div>
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600  hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500" onClick={login_ }
            >
              Sign in
            </button>
          </div>
